...
async def consumer_subscriptions():
    ...
    imperial_test__declared = await channel.queue_declare("reminder24:internal__messager:imperial_test")
    ...
    await channel.basic_consume(imperial_test__declared.queue, handlers.imperial_test)
